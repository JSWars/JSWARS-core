...
Game.prototype.tick = function () {
	...
	Logger.log('debug','IS VISIBLE'+this.map.checkObsFreeDistance(this.teams[0].units[0].position,this.teams[1].units[0].position,this.teams[0].units[0],this.teams[0].units[0].radius))
